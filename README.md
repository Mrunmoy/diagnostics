...
| Read-only dashboard data from diagnostics | `examples/grafana_reader` | Shows how tester-collected state can become Prometheus metrics and JSON without putting dashboard code in firmware. |
