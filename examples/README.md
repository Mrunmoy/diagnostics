...
`modbus_rtu_transport` keeps the same diagnostic workflow but wraps payloads in
Modbus RTU-style address/function/CRC framing. Its CTest also uses
pseudo-terminals, so no RS-485 hardware is required.
